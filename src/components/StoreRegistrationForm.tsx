...
import { Upload, Check, Eye, ArrowRight } from "lucide-react";
          ...
          <div className="mb-10">
            <div className="flex justify-between items-center">
              ...
              >
                ...
                <span className="mt-2 text-sm font-medium">Customization</span>
              </div>
            </div>
          </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleColorChange(customPrimaryColor, e.target.value);
                        }}
                        className="w-full h-10 cursor-pointer rounded"
                      />
                      <div className="mt-2">
                    ...
                    <div className="p-4">
                      ...
                      <div className="mt-4 grid grid-cols-2 gap-2">
                        {photosPreviews.length > 1 ? (
                          photosPreviews.slice(1, 5).map((preview, index) => {
                            const pageLabels = [
                              "Store",
                              "About",
                              "Contact",
